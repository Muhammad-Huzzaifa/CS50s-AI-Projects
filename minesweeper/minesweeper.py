    ...
    def add_knowledge(self, cell, count):
        ...
        while changed:
            ...
            for setence in self.knowledge:
                safes |= setence.known_safes()
                mines |= setence.known_mines()
            ...
            for sentence1 in self.knowledge:
                for senetence2 in self.knowledge:
                    if sentence1 != senetence2 and \
                            sentence1.cells.issubset(senetence2.cells):
                        new_cells = senetence2.cells - sentence1.cells
                        new_count = senetence2.count - sentence1.count
                        new_sentence = Sentence(new_cells, new_count)
                        if new_sentence not in self.knowledge and \
                                new_sentence not in new_setences:
                            new_setences.append(new_sentence)
                            changed = True
            self.knowledge.extend(new_setences)
