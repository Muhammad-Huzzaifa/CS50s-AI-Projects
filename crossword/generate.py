    ...
    def consistent(self, assignment):
        ...
        for variable, word in assignment.items():
            ...
            for other_variable in assignment:
                if other_variable != variable and assignment[other_variable] == word:
                    return False
            ...
            for neighbor in self.crossword.neighbors(var):
                if neighbor not in assignment:
                    for neighbor_value in self.domains[neighbor]:
                        ...
                        copy[var] = value
                        copy[neighbor] = neighbor_value
                        count += not self.consistent(copy)
            return count
    ...
    def backtrack(self, assignment):
        ...
        for word in self.order_domain_values(variable, assignment):
            ...
            if self.consistent(assignment):
                ...
                if self.ac3([(neighbor, variable) for neighbor in self.crossword.neighbors(variable)]):
